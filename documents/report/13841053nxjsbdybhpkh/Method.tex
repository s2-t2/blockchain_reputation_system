...
\begin{center}
	\begin{tabular} {| l | p{9cm} | l |}
		...
		\hline
		\multirow{2}{Endorser} & join network using  only public address& R1.1 \\\cline{2-3} 
		& view/edit my profile information and access permission 
		for other participants & R1.2 \\\cline{2-3}
		& send endorsement to known acquaintances that are registered 
		on the network & R1.2 \\\cline{2-3}
		& view trustscore of all the participants &  \\\cline{2-3}
		& identify myself for any transactions  & R1.2 \\\cline{2-3}
		& view trustscore for all the addresses stored in the network. & R1.2 \\\cline{2-3}
		& remove endorsement that i had previously sent if i dont trust them 
		anymore & R1.3 \\\cline{2-3} 
		\hline
		\multirow{2}{*}{Endorsee} & securely login to the network & R2.1 \\\cline{2-3}
		& identify myself for any transactions using only the public address & 2 \\\cline{2-3}
