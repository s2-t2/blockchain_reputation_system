...
different purposes (e.g., digital transaction, file upload or download, news
posting) can be termed as an online interaction system. Reputation model of
such system is essential in maintaining its security. The risk of failure or
...
be assumed to be more robust. Trust frameworks and reputation models attempt to
...
\begin{wrapfigure}{l}{0.6\textwidth}
	...
	\end{center}
\end{wrapfigure}
Examples of reputation systems are eBay, which is an e-commerce platform, and
