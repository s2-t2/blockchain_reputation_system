...
points that they can spend at will once registered on the network. The initial
point is one that keeps depleting with every endorsement interaction. In other
words, sending an endorsement is using up the points one owns. 
