...
\begin{figure}
	\includegraphics[width=1.4\textwidth]{Images/2Container.eps}
...
%It is more like a cluster of small-world graph topology(cite graph section). 
The recent
breakthrough in consensus engine is proposed by hashgraph(cite) that claims to
be fair(no bias as in other systems where miners get to decide which
