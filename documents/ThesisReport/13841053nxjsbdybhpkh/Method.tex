...
\begin{enumerate}
	...
	\item Trust metrics should describe the actual trust score of the nodes:
		The definition of honest or malicious interactions based on the
		...
		a higher rank than the malicious ones in the endorsement system.  
\end{enumerate}
