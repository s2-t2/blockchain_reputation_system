...
\end{itemize}
%\begin{itemize}
%	\item \displaystyle${V}$ \text{ is a non empty set of vertices }  
%		\displaystyle${ v}.$ \\ 
%	\item 
%	\item \displaystyle${E}$ \text{ is a non empty set of edges }
%		\displaystyle${ e}.$ \\ 
%	\item \displaystyle${e}$ \text{ connects two vertices, where, }
%		\displaystyle${v \in V }$ \text{ and } $\displaystyle{e \in E}.$ \\
%	\item \displaystyle${\varphi _G}$ \text{ is an incidence function that
%		assigns pair of vertices to each edge of the graph G.} \\
%	\item \displaystyle${\varphi _G(e) = uv}$ \text{ represents that }
%		\displaystyle${e}$ \text{ is an edge that joins vertices }
