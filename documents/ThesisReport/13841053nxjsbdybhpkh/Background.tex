...
Everledger~\footnote{https://www.everledger.io/} is a blockchain platform that
...
%application to the blockchain network. Examples of private blockchain platforms
%are hyper ledger
...
\end{itemize}
%It is essentially a chain of blocks, as the name suggests.  Each block consists
%of a list of transactions and the ordering of block shows the time at which the
%particular block was added to the chain.  The data structure of blockchain is
%analogous to singly linked list with each blocks having a hash value pointing
%to the previous block. \par
...
\paragraph{Proof-Of-Work (PoW):}This is the most widely
...
platforms. Examples include solidity, serpent, LLL.  Contract's code resides in
